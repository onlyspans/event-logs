...
class EventControllerTest {
    ...
    void searchEvents_shouldReturnResults() {
        ...
        // When
        QueryResult actualResult = eventController.searchEvents(
            "test-user", "test-category", null, null, null, null, null, null, null,
            null, null, "timestamp", "desc", 0, 20
        );
        ...
        verify(eventService).searchEvents(any(QueryDto.class));
    }
    ...
    void searchEvents_shouldPassAllParametersToService() {
        ...
        eventController.searchEvents(
            "user1", "cat1", "action1", "doc1", "proj1", "env1", "tenant1",
            "corr-123", "trace-456", start, end, "user", "asc", 1, 50
        );
